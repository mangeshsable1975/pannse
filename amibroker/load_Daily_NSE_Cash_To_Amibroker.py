...
def download_historical_data(ticker, startdate, enddate):
	...
	#print("DATA......")
	#print(stock_ohlc_data.head())
	return stock_ohlc_data


#schedule.every(1).minutes.do(download_historical_data,'TCS',from_date,to_date)
